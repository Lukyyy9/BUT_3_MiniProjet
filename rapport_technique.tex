...
\begin{enumerate}
    ...
    \begin{lstlisting}[style=mystyle]chmod +x BUT_3_MiniProjet.sh
    mkdir -p ~/bin
...
\section{Annexes}
Le script Bash complet, le README.md ainsi que le code source LaTeX de ce rapport, sont disponibles sur GitHub à l'adresse suivante : \url{https://github.com/Lukyyy9/BUT_3_MiniProjet}.
Pour lire le README.md, vous pouvez utiliser, dans le répertoire du fichier, la commande pandoc README.md -s -t man | /usr/bin/man -l -
